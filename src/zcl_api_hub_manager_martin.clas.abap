CLASS zcl_api_hub_manager_martin DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_api_hub_manager_martin IMPLEMENTATION.
  METHOD constructor.
  ...
  METHOD get_bank_details.
    ...
    lo_request->set_header_fields( VALUE #(
       ...
       (  name = 'APIKey' value = ' eIblkfhGGUhY0wtWPlDASgXLpD2KDKKf') ) ).

    lo_request->set_uri_path(
       i_uri_path = gv_url && |API_BANKDETAIL_SRV/A_BankDetail?$top=25&$format=json&$filter=BankCountry eq 'DE'| ).
