CLASS lhc_travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    METHODS validatecustomer FOR VALIDATION travel~validateCustomer IMPORTING keys FOR travel.

    METHODS validatedates FOR VALIDATION  travel~validateDates IMPORTING keys FOR travel.
...
CLASS lhc_travel IMPLEMENTATION.
  ...
  METHOD validateCustomer.
    ...
    READ ENTITY Z_I_Travel_M_MAR\\travel FIELDS ( customer_id ) WITH
  ...
  METHOD validateDates.
    ...
    READ ENTITY Z_I_Travel_M_MAR\\travel FIELDS ( begin_date end_date )  WITH
          VALUE #( FOR <root_key> IN keys ( %key = <root_key> ) )
  ...
  ENDMETHOD.
    ...
    MODIFY ENTITIES OF Z_I_Travel_M_MAR IN LOCAL MODE
           ENTITY travel
    ...
    READ ENTITIES OF Z_I_Travel_M_MAR IN LOCAL MODE
         ENTITY travel
           FIELDS ( agency_id
                    customer_id
                    begin_date
